...
function loremIpsumSentence(numWords: number) {
  let s = '';
...
function loremIpsumSentence2(numWords: number) {
  let s = '';
  s += capitalize(getLoremWord()) + ' ';
  let part1 = 0;
  if (chance(50)) {
...
function loremIpsumParagraph(numWords: number) {
  let s = '';
  let w;
  let words = numWords;
  while (words > 0) {
...
export { loremIpsum, loremIpsumSentence, loremIpsumSentence2, loremIpsumParagraph };
